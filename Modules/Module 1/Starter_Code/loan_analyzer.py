...
# YOUR CODE HERE!
avg_of_loans = sum_of_loans/num_of_loans

print(f"There are {num_of_loans} loans for a total amount of ${sum_of_loans} and an average amount of ${avg_of_loans}")
...
# YOUR CODE HERE!
def calc_present_value(future, remaining, discount):
    present_value = future / (1 + (discount / 12)) ** remaining
